BeforeAll {
    ...
    $script:SourcePath = Join-Path $repoRoot 'src/CharlandCustomizations/Public/AWS/Lambda/Lambda-Customizations.psm1'
}

Describe 'Lambda-Customizations.psm1 source test' {
