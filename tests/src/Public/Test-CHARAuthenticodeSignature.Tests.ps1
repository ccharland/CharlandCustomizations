BeforeAll {
    ...
    $script:SourcePath = Join-Path $repoRoot 'src/CharlandCustomizations/Public/Test-CHARAuthenticodeSignature.ps1'
}

Describe 'Test-CHARAuthenticodeSignature.ps1 source test' {
