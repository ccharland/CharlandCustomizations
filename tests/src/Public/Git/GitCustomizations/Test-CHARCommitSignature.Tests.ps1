BeforeAll {
    ...
    $script:SourcePath = Join-Path $repoRoot 'src/CharlandCustomizations/Public/Git/Test-CHARCommitSignature.ps1'
}

Describe 'Test-CHARCommitSignature.ps1 source test' {
