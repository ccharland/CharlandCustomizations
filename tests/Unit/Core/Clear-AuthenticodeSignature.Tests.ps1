...
#>
BeforeAll {
    . "$PSScriptRoot/../../../src/CharlandCustomizations/Public/Clear-AuthenticodeSignature.ps1"
}
...
"@
            ...
            # Act
            Clear-AuthenticodeSignature -Path "TestDrive:\signed-script.ps1"
...
"@
            ...
            # Act
            Clear-AuthenticodeSignature -Path "TestDrive:\unsigned-script.ps1"
    ...
    Context 'Error handling' {
        ...
        It 'Non-existent file path writes non-terminating error containing the path' {
            ...
            # Act & Assert
            $err = $null
            Clear-AuthenticodeSignature -Path $badPath -ErrorVariable err -ErrorAction SilentlyContinue
    ...
    Context 'Property: content preservation' {
        ...
        It 'Preserves content before signature block for 100 random inputs' {
            foreach ($i in 1..100) {
                ...
                Clear-AuthenticodeSignature -Path "TestDrive:\proptest$i.ps1"
        ...
        It 'Leaves file unchanged when no signature block present for 100 random inputs' {
            foreach ($i in 1..100) {
                ...
                Clear-AuthenticodeSignature -Path "TestDrive:\noprop$i.ps1"
