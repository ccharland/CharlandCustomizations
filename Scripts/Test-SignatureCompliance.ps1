...
try {
    ...
    # Non-console hosts (ISE, VS Code, Pester) can't query Console.IsOutputRedirected.
    # Treat as redirected so objects are emitted instead of thrown.
...
if ($invalidSignatures.Count -gt 0) {
    ...
    # Always emit objects to the pipeline so callers can capture results
    $invalidSignatures | Write-Output

    if (-not $isPipelineOutput -and -not $isRedirectedOutput) {
        # Interactive terminal with no pipe/redirect: exit with failure code
        exit 1
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCeVBF/RvuBLbnH
# /8/+lKpG9SjQ77QdEeywWOnn2DL6dKCCJOUwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# hvcNAQkEMSIEIHYyWDU4cUYqMl+CJjYonvs0CdbGmGlJ1+qudqPc8T7EMA0GCSqG
# SIb3DQEBAQUABIICAIkRroSVSoncXXXJg/Rb7/FrrmfLi/wE4CF1TSahthzvFoF3
# oeDZtzSKhIprT00qUX0E56eS636Q0P6UucCeAwDUdnQM7vdLbJuzbwVRgf8EfVr5
# uvwI+EemH8cmWITMogkiXFFlG63JHrL7F0QIR60EtuAZt6VyIixRgKS4Ms9XRXGq
# g5dkZfF6Hb8Gvej2sqKpPlA5/09NrOkMdJMtA6r2KIu2XeaOKM9jLPVxaJveFTil
# ZZwnKiE14ksoGxX8CDa7dwaAqihA29eBz5mVo+GyRVq1zNZ+Lko2dkJLfPeVKmgc
# Ujf/8km/Re8FMvUcQXawPN8YVmLY98hlGPWe687YC02xjiIGPRrkHqlk4jP17mjt
# 6w2SXlSSxHlB7w3ZGGQbfd9Ervl0PQfZa0dIVLkCpraxoF9JzaYAsQMkT1iJ5Teg
# pDQJk3+tAGFbkF8sa8OL7/5XzJBU3wBXaqosJu+yz1YDlhw2FWaMuQxvzlaZz+nZ
# kii2CEXOZcMwV3J6QCvQUSHSoJOkch/wBEG+kOWlAiZRIfZGjEbziv8k8Jg7Hul5
# iQINgb/qASPXsh0V6tEyQV9LjoqAmP8PN9SjjKXwa2nn8rU1c7FUIBxCBXBFmth3
# 1+ZIpTGoGNVj6kqQ8R1c3ijQUplRJWJip9xF8gLOHVtIoBZkv32BL4AvVV9poYID
...
# DxcNMjYwNjA2MDAzNzE4WjA/BgkqhkiG9w0BCQQxMgQwKJwVO5d4vMfdqVUwh6+2
# AEr4HiVtWFkWYtK3yWSvfyyCp70cVGnC5jy/u2RPIVv2MA0GCSqGSIb3DQEBAQUA
# BIICAMc9fmENO0QcekTx5HuNYHHojQkfVGeKb3I4VCwPhta7LF84iCGv9eGUJfzp
# gWb432ZkKUIf5ZuMbTZmDBxBKols7Uuy80W6vVdhLLQzybS3/ZjiF6ec/kTAFj/f
# 7Po/H2t8RW5GhADPOHicdxEyEp1hgUrTlDTuuFmkH0/R3ya4bPPJBZrbDbZbNXIC
# ZuZcBeYKSeiBq7Shfs3a1vTY1Mno1j8b5JFcXGxU2QxRq7InHBX2CfIIAeQPWcjN
# ErP4TzzbwKNQ3Aa3B3xFnEAjoW3ByLJ8BiwXs2DD2HOw5gLbWzzhtKB5sIa9Rk1y
# pyx8+sGOuFeVesaxR9RQMisZ0Zk6+f1fo6HrbUqv4tsdzNbiGpgccQyxi+gQZBAM
# ouYOiv8gatmup6mGYpDVTipu16SukPIYJfa0l+G1YsZsQEGOLZBRJGA4NhTw2zRm
# mp92sF09HMchmT7Ae82N/pL1Irv0WUIiUA0CZ3A24dQzcMfkRo7vKi9IoCtcfrM7
# 76/tVRgSwaeTBvlUBH1QdonDOgnsozY95uEtiHAKPhFoLkrw2IU7eNBzFeGcE2h+
# ZAm8wYm9v6mxlGT7Ec6bVYvZfIveK77Phmp3VaKF/jWp8iV+XqznXyv6mSiMWLn6
# 18MCJnUSRKBpQdH299+1JTlgSAVIkUhDb77J4txQfS33/Kuv
